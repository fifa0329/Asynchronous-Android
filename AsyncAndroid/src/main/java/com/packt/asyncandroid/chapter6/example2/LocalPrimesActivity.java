    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (service == null) {
                    Toast.makeText(LocalPrimesActivity.this, "service not bound", Toast.LENGTH_LONG).show();
                } else {
                    ...
                    for (String value : values) {
                        if (value.trim().matches("[1-9]+[0-9]*")) {
                            ...
                            Toast.makeText(LocalPrimesActivity.this, "not a number!", Toast.LENGTH_LONG).show();
                        }
                    }
                }
            }
